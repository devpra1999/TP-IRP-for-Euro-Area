...
f_6 <- read.csv("6-months.csv", skip = 6,col.names = c("Date","Q2_forecast","Type"), header = FALSE)
f_6 <- f_6[order(f_6$Date),]
f_6$Date = as.Date(as.yearqtr(f_6$Date, format = "%YQ%q")) + months(3)

f_9 <- read.csv("9-months.csv", skip = 6,col.names = c("Date","Q3_forecast","Type"), header = FALSE)
...
f_27 <- read.csv("27-months.csv", skip = 6, col.names = c("Date", "Q9_forecast", "Type"), header = FALSE)
f_27 <- f_27[order(f_27$Date),]
f_27$Date <- as.Date(as.yearqtr(f_27$Date, format = "%YQ%q")) + months(12)

f_30 <- read.csv("30-months.csv", skip = 6, col.names = c("Date", "Q10_forecast", "Type"), header = FALSE)
f_30 <- f_30[order(f_30$Date),]
f_30$Date <- as.Date(as.yearqtr(f_30$Date, format = "%YQ%q")) + months(12)

f_33 <- read.csv("33-months.csv", skip = 6, col.names = c("Date", "Q11_forecast", "Type"), header = FALSE)
f_33 <- f_33[order(f_33$Date),]
f_33$Date <- as.Date(as.yearqtr(f_33$Date, format = "%YQ%q")) + months(12)

f_36 <- read.csv("36-months.csv", skip = 6, col.names = c("Date", "Q12_forecast", "Type"), header = FALSE)
...
France_inf <- read.csv("France-inflation.csv", skip = 6, header = FALSE)
...
Italy_inf <- read.csv("Italy-inflation.csv", skip = 6, header = FALSE)
...
Spain_inf <- read.csv("Spain-inflation.csv", skip = 6, header = FALSE)
