...
Germany_GDP$Growth_q <- (Germany_GDP$GDP/lag(Germany_GDP$GDP,1) - 1)*100
Germany_GDP$Growth_a <- (Germany_GDP$GDP/lag(Germany_GDP$GDP,4) - 1)*100
...
France_GDP$Growth_q <- (France_GDP$GDP/lag(France_GDP$GDP, 1) - 1) * 100
France_GDP$Growth_a <- (France_GDP$GDP/lag(France_GDP$GDP, 4) - 1) * 100
...
Italy_GDP$Growth_q <- (Italy_GDP$GDP / lag(Italy_GDP$GDP, 1) - 1) * 100
Italy_GDP$Growth_a <- (Italy_GDP$GDP / lag(Italy_GDP$GDP, 4) - 1) * 100
...
Spain_GDP$Growth_q <- (Spain_GDP$GDP/lag(Spain_GDP$GDP, 1) - 1) * 100
Spain_GDP$Growth_a <- (Spain_GDP$GDP/lag(Spain_GDP$GDP, 4) - 1) * 100
