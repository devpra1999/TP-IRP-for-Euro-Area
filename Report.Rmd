...
The report gives the procedure used for the computation of the estimates and summarize the results obtained.
...
The following plot compares the long-term bond yields of Germany, France, Italy and Spain


![](Plots/Historical/Long Term Government Bond Yields.png){width="80%"}
\bigskip

We can see one crucial feature - the bond yield were similar across all the countrie till 2008 and then diverged, with Italy and Spain having higher long-term-bond yields than Germany and France.

We can also get the yield decompositions for the countries - the term premia are calculated using the two methods described previously.

![](Plots/Historical/Yield_decomposition_Germany.png){width="50%"}![](Plots/Historical/Yield_decomposition_Italy.png){width="50%"}
![](Plots/Historical/Yield_decomposition_France.png){width="50%"}![](Plots/Historical/Yield_decomposition_Spain.png){width="50%"}

From the decomposition plots, we can infer that most of the term spread can be explained by the term premia, and the short-rate movements contribute little to the term spread. This has important implications for...

We also see a downward shift of the term premia in the recent years, with it reaching negative values in Germany and Franc. In Germany, the term premia has been negative since before even 2020. This matches the US experience, showing similarities in term premia across the two regions.
\pagebreak

Finally, the following two figures summarise the term premia estimates:

![](Plots/Historical/Model Term Premia estimates.png){width="50%"}![](Plots/Historical/Consensus Term Premia estimates.png){width="50%"}
